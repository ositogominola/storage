...
CREATE TABLE `recursos` (
  ...
  KEY `FKo3gid2ou9uti83f3i84a2vrfn` (`perfil_item_id`),
  CONSTRAINT `FKo3gid2ou9uti83f3i84a2vrfn` FOREIGN KEY (`perfil_item_id`) REFERENCES `perfiles_items` (`id_perfil`)
...
INSERT INTO `recursos` VALUES (1,'/AdminRoles','#5ce374',NULL,'Administrar Roles',4),(2,'/AdminPerfiles','#5ce374',NULL,'Administrar Perfiles',4),(3,'/Factorys','#5ce374',NULL,'Administrar Empresas',1),(4,'/UsersAdmin','#708AF4',NULL,'Administrar Usuarios',2);
